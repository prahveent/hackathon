  ...
  private mockProducts: ProductDetail[] = [
    {
      ...
      mainImageUrl: '/assets/images/headphones.jpg',
      ...
      productImages: [
        { id: 1, imageUrl: '/assets/images/headphones.jpg', altText: 'Wireless Headphones', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
    ...
    },
    {
      ...
      mainImageUrl: '/assets/images/tshirt.jpg',
      ...
      productImages: [
        { id: 2, imageUrl: '/assets/images/tshirt.jpg', altText: 'Cotton T-Shirt', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
    ...
    },
    {
      ...
      mainImageUrl: '/assets/images/garden-system.jpg',
      ...
      productImages: [
        { id: 3, imageUrl: '/assets/images/garden-system.jpg', altText: 'Smart Garden System', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
    ...
    },
    {
      ...
      mainImageUrl: '/assets/images/running-shoes.jpg',
      ...
      productImages: [
        { id: 4, imageUrl: '/assets/images/running-shoes.jpg', altText: 'Running Shoes', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
    ...
    },
    {
      ...
      mainImageUrl: '/assets/images/programming-book.jpg',
      ...
      productImages: [
        { id: 5, imageUrl: '/assets/images/programming-book.jpg', altText: 'Programming Cookbook', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
    ...
    },
    {
      ...
      mainImageUrl: '/assets/images/phone-case.jpg',
      category: { id: 1, name: 'Electronics', description: 'Latest electronic gadgets and devices', isActive: true, displayOrder: 1, productCount: 25 },
      brand: { id: 1, name: 'TechnoCore', description: 'Premium technology products', isActive: true, productCount: 18 },
      productImages: [
        { id: 6, imageUrl: '/assets/images/phone-case.jpg', altText: 'Smartphone Case', displayOrder: 1, isMain: true }
      ],
      productAttributes: [
