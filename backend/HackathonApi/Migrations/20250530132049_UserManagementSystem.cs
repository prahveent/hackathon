...
{
    /// <inheritdoc />
    public partial class UserManagementSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionsLevel = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 30, 13, 20, 48, 360, DateTimeKind.Utc).AddTicks(5163), "Regular customer with shopping access", "customer" },
                    { 2, new DateTime(2025, 5, 30, 13, 20, 48, 360, DateTimeKind.Utc).AddTicks(5350), "Administrator with full system access", "admin" }
                });
